"""
Django settings for prismRH project.
...
SECRET_KEY = "django-insecure-2(0ue45b7z(%)j%q=o(a)%qotb(n996-^pd+87-*xkdw@5ukk9"
...
WSGI_APPLICATION = "prismRH.wsgi.application"
