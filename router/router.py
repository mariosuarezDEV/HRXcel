class AdministradorDBRouter:
    ...
    def allow_relation(self, obj1, obj2, **hints):
        if obj1._meta.app_label in self.router_app_labels or obj2.meta.app_label in self.router_app_labels:
            return True
        return None
...
class EmpleadosRouter:
    ...
    def allow_relation(self, obj1, obj2, **hints):
        if obj1._meta.app_label == 'empleados' or obj2.meta.app_label == 'empleados':
            return True
        return None
...
class DepartamentosRouter:
    ...
    def allow_relation(self, obj1, obj2, **hints):
        if obj1._meta.app_label == 'departamentos' or obj2.meta.app_label == 'departamentos':
            return True
        return None
